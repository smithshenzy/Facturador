...
<script>
    ...
    export default {
        ...
        components: {DocumentsVoided,DocumentValidate, ItemsImport, DocumentImportSecond, DocumentOptions, DocumentPayments, DataTable, DocumentConstancyDetraction, ReportPayment, ReportPaymentComplete },
        data() {
            return {
